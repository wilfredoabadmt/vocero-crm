...
- Do not treat a freshly onboarded number as usable until `/register` succeeds.
...
- a phone number registration step that activates the number after onboarding,
