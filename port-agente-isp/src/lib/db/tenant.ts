...
/**
 * Scope de tenant OBLIGATORIO.
 *
 * Toda query de dominio se construye con `scoped(...)`: exige el
 * organization_id explícito y lo combina con el resto de condiciones, de modo
 * que un WHERE sin tenant no se escribe por accidente.
 *
 * Si tu proyecto ya tiene este helper, usa el tuyo y borra este archivo.
 */
